...
class Settings(BaseSettings):
    ...
    PG_ADMIN_URL: str = os.getenv("PG_ADMIN_URL", "postgresql://postgres:password@localhost/postgres")
    ACCESS_TOKEN_EXPIRE_MINUTES: int = 30
    DATABASE_URL: str = os.getenv("DATABASE_URL", "postgresql://user:password@localhost/test_db")
